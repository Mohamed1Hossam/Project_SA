...
// const warehouse = [
//     { carName: "car1", quantity: 10},
//     { carName: "car2", quantity: 2 },
//     { carName: "car3", quantity: 3 },
//     { carName: "car5", quantity:4},
//     { carName: "car6", quantity: 5 }
// ];
// function m(element) {
...
//       resultContainer.innerHTML = `<h1>${car.carName} has been purchased. Remaining stock: ${car.quantity}</h1>`





//         alert(`${car.carName} has been purchased. Remaining stock: ${car.quantity}`);
//     } else {
//         resultContainer.innerHTML = `<h1>Sorry, ${car.carName} is out of stock.</h1>`;
//         // alert(`Sorry, ${car.carName} is out of stock.`);
//     }
